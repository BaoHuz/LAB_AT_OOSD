...
namespace QuanLyKhachSan.Services
{
    public class PhongTienNghiService
    {
        ...
        public DataTable LayLapDat() => Db.Query("SELECT p.*, l.TenLoaiTN FROM PhieuLapDat p JOIN TienNghi t ON p.MaTienNghi=t.MaTienNghi JOIN LoaiTienNghi l ON t.MaLoaiTN=l.MaLoaiTN ORDER BY NgayLap DESC");
