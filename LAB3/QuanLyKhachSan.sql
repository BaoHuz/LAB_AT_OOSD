...
('KH01', N'Nguyễn Văn A', '001099000001', N'Việt Nam', '0912345678'),
('KH02', N'Trần Thị B', '001099000002', N'Việt Nam', '0987654321'),
('KH03', N'John Smith', 'PASS123456', N'Mỹ', '0909123456');
...
('DP001', 'KH01', 'NV01', GETDATE(), GETDATE(), DATEADD(day, 2, GETDATE()), 500000, N'Website', N'Đang ở', GETDATE(), NULL),
('DP002', 'KH02', 'NV01', GETDATE(), DATEADD(day, 1, GETDATE()), DATEADD(day, 3, GETDATE()), 300000, N'Điện thoại', N'Đã đặt', NULL, NULL),
('DP003', 'KH03', 'NV01', DATEADD(day, -5, GETDATE()), DATEADD(day, -5, GETDATE()), DATEADD(day, -3, GETDATE()), 1000000, N'Trực tiếp', N'Đã trả', DATEADD(day, -5, GETDATE()), DATEADD(day, -3, GETDATE()));
